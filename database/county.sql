...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 09, 2024 at 09:56 PM
...
CREATE TABLE `documents` (
  ...
  `viewer_position` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `documents` (`id`, `name`, `path`, `type`, `uploaded_at`, `viewer_position`) VALUES
(36, 'CLEANING LOGS (1).pdf', '', 'application/pdf', '2024-09-09 19:41:43', '\"Director Economic Planning\"\r\n\"Director Internal Audit\";\"Director Revenue\";Director Supply Chain Management\";\"Director Survey\";\"Director Valuation\";\"Director Sports\";\"Director Y'),
(38, 'Dental Lab Commodity.pdf', '', 'application/pdf', '2024-09-09 19:51:23', 'a:1:{i:0;s:18:\"Director Transport\";}'),
(39, 'Dental Lab Commodity.pdf', '', 'application/pdf', '2024-09-09 19:51:30', 'a:1:{i:0;s:18:\"Director Transport\";}');
...
(35, 'County Executive Committee(Cabinet) Meeting', '', '0000-00-00', '00:00:00', '', '', '', '', '', '', ''),
(36, 'County Public Service Board', '', '0000-00-00', '00:00:00', '', '', '', '', '', '', '');
...
(54, 'County Executive Committee(Cabinet) Meeting', '2024-08-26', 'Muranga county', '10:03:00.000000', 'Director Accountant Governorship and coordination, Director Accountant Youth Affairs sports culture social services, Director Accounting Services, Director Admin, Director Communication, Director Culture, Director Disaster and fire, Director Economic Planning, Director Finance, Director Internal Audit, Director Revenue, Director Social Services, Director Sports, Director Supply Chain Management, Director Survey, Director Transport, Director Valuation, Director Youth', '123', 'downloads/CLEANING LOGS (1).pdf'),
(55, 'Department of Public Service Administration & ICT', '2024-09-09', 'Muranga county', '00:26:00.000000', 'Chief Officer Lands Survey', '1', '');
