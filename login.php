...
<head>
  ...
  <title>Admin | ECABINET MURANG'A</title>
  			...
  			<div class="card col-md-8">
				  ...
				  <h4>Admin Login</h4>	
  					<form id="login-form" >
  						...
  						<div class="form-group">
  							<label for="password" class="control-label">Id</label>
		...
		$('#login-form button[type="button"]').removeAttr('disabled').html('Login');
			...
			success:function(resp){
				if(resp == 1){
					...
					$('#login-form').prepend('<div class="alert alert-danger">personal_number or ID is incorrect.</div>')
					$('#login-form button[type="button"]').removeAttr('disabled').html('Login');
				}
			}
		})
